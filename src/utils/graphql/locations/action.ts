"use server";
import { CreateLocationInput, LocationsInput, LocationsResponse,CreateLocationResponse,UpdateLocationInput,UpdateLocationResponse } from "@/types/location";
import { fetchGraphQLMutation, fetchGraphQLQuery } from "..";
import { CREATE_LOCATION_MUTATION, GET_LOCATIONS_BY_ORG_QUERY, UPDATE_LOCATION_MUTATION } from "./query";
