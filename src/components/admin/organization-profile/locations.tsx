...
interface LocationsProps {
    locationList: LocationByOrg[];
    openCreateModal: () => void;
    openEditModal: (location: LocationByOrg) => void;
    requestDeleteLocation: (location: LocationByOrg) => void;
}
                        ...
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    {/* <p className="text-xs text-gray-500">{location?.label}</p> */}
